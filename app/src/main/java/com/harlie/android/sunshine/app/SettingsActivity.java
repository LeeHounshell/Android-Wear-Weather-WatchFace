...
public class SettingsActivity extends PreferenceActivity
        ...
        if (preference instanceof ListPreference) {
            ...
            switch (status) {
                ...
                case SunshineSyncAdapter.LOCATION_STATUS_SERVER_DOWN:
                    preference.setSummary(getString(R.string.pref_location_server_down, value.toString()));
                    break;
                case SunshineSyncAdapter.LOCATION_STATUS_SERVER_INVALID:
                    preference.setSummary(getString(R.string.pref_location_server_invalid, value.toString()));
                    break;
                default:
    ...
    public Intent getParentActivityIntent() {
        ...
        if (pai != null) {
            pai.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        }
        return pai;
    }
}
