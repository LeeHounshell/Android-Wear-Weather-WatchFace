...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public SunshineSyncAdapter(Context context, @SuppressWarnings("SameParameterValue") boolean autoInitialize) {
     ...
     */
    private static void configurePeriodicSync(Context context, @SuppressWarnings("SameParameterValue") int syncInterval, @SuppressWarnings("SameParameterValue") int flexTime) {
